...
The choice of a particular college can dramatically influence a person’s future not in the least that of job opportunities. Since most students will incur a significant amount of debt over the course of their study program, it is vitally important that job opportunities after obtaining a certificate, undergraduate, or graduate degree will allow one to repay the debt without having to forego the necessities of living. This project explores to what extent institutional characteristics as well as certain demographic factors can indicate/predict debt repayment.
